...
public class QuizActivityTres extends AppCompatActivity {
	List<Question> quesListTres;
	int score=0;
	int qid=0;
	Question currentQ;
	...
	public void esperar() {
		...
		quesListTres=db.getAllQuestionsTres();
		currentQ=quesListTres.get(qid);
		...
		butNext.setOnClickListener(new View.OnClickListener() {		
			...
			public void onClick(View v) {
				...
				if(qid<3){
					...
					Intent intent = new Intent(QuizActivityTres.this, ResultActivityTres.class);
					Bundle b = new Bundle();
